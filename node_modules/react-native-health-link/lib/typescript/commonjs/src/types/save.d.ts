...
import { BloodGlucoseUnit, HeartRateUnit, HeighUnit, StepsUnit, WeightUnit } from './units';
...
export type Unit = BloodGlucoseUnit | WeightUnit | StepsUnit | HeighUnit | HeartRateUnit;
export type WriteOptions<T extends WriteDataType> = WriteOptionsBase<T> & (T extends HealthLinkDataType.Steps ? {
    startDate: string;
    endDate: string;
} : {
    startDate?: string;
 ...
 */
export type WriteDataType = HealthLinkDataType.BloodGlucose | HealthLinkDataType.Height | HealthLinkDataType.Weight | HealthLinkDataType.HeartRate | HealthLinkDataType.Steps;

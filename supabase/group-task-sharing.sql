...
revoke all on function public.share_task_with_group(uuid, text, text, text, date, text) from public;
grant execute on function public.share_task_with_group(uuid, text, text, text, date, text) to authenticated;
